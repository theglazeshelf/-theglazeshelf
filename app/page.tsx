...
export default function App(){
 ...
 return <>{showLoginSpin&&<div className="pottery-login-intro" aria-hidden="true"><div className="pottery-wheel-ring"><div className="pottery-wheel-cup"><img src={purpleLogo.src} alt=""/></div></div></div>}<main className={"shell "+(tab==="home"?"home-shell":"")}>{tab!=="home"&&<div className="row app-header"><div className="brand"><img className="header-final-logo" src={purpleLogo.src} alt="The Glaze Shelf"/></div><button className="nav" aria-label="Sign out" onClick={()=>sb.auth.signOut()}><LogOut size={18}/></button></div>}
 {tab==="home"&&<>
