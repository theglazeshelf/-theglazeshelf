...
export default function App(){
 ...
 return <main className="shell"><div className="row app-header"><div className="brand"><img className="header-final-logo" src={purpleLogo.src} alt="The Glaze Shelf"/></div><button className="nav" aria-label="Sign out" onClick={()=>sb.auth.signOut()}><LogOut size={18}/></button></div>
 {tab==="home"&&<>
 <section className="home-dashboard-hero"><img className="home-final-logo" src={purpleLogo.src} alt="The Glaze Shelf"/><h1>Ready for your next glaze test?</h1><p>Build it. Fire it. Learn from it.</p></section>
